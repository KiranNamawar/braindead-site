...
export function SearchProvider({
  ...
  const searchService = useMemo(
    () => new SearchService(utilities),
    [utilities]
  );
  const recentSearchesService = useMemo(
    () => new RecentSearchesService("recentSearches", 5),
    []
  );
  const recentUtilitiesService = useMemo(
    () => new RecentSearchesService("recentUtilities", 5),
    []
  );
