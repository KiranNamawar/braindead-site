  ...
  private initializeDefaultTools(): void {
    ...
    const existingTools: Tool[] = [
      ...
      },
      {
        ...
        description: 'Encode and decode Base64 data with URL-safe variants',
        sarcasticQuote: 'Making gibberish readable since 1987',
        path: '/base64-encoder',
        icon: 'Code2',
        gradient: 'linear-gradient(135deg, #3b82f6, #8b5cf6)',
        category: ToolCategory.DEVELOPER,
        features: ['Bidirectional encoding/decoding', 'URL-safe Base64', 'File upload support', 'Batch processing'],
        keywords: ['base64', 'encode', 'decode', 'binary', 'data', 'url-safe'],
        shortcuts: ['base64', 'encode', 'decode'],
        isPremium: false,
        estimatedTimeSaved: 5,
        isNew: true
      },
      {
        ...
        description: 'Encode, decode, and analyze URLs with component parsing',
        sarcasticQuote: 'Making URLs readable by humans again',
        path: '/url-encoder',
        icon: 'Link2',
        gradient: 'linear-gradient(135deg, #10b981, #06b6d4)',
        category: ToolCategory.DEVELOPER,
        features: ['URL encoding/decoding', 'Component parsing', 'Query parameter extraction', 'URL validation'],
        keywords: ['url', 'encode', 'decode', 'parse', 'query', 'parameters'],
        shortcuts: ['url', 'encode', 'decode'],
        isPremium: false,
        estimatedTimeSaved: 4,
        isNew: true
      },
      {
        ...
        description: 'Live markdown editor with syntax highlighting and preview',
        sarcasticQuote: 'Write formatted text without the formatting headaches',
        path: '/markdown-editor',
        icon: 'FileText',
        gradient: 'linear-gradient(135deg, #8b5cf6, #ec4899)',
        category: ToolCategory.DEVELOPER,
        features: ['Live preview', 'Syntax highlighting', 'Export HTML/MD', 'Formatting toolbar'],
        keywords: ['markdown', 'editor', 'preview', 'syntax', 'highlighting', 'export'],
        shortcuts: ['markdown', 'md', 'editor'],
        isPremium: false,
        estimatedTimeSaved: 10,
        isNew: true
      },
      {
        id: 'uuid-generator',
        name: 'UUID Generator',
        description: 'Generate and validate UUIDs in multiple versions and formats',
        sarcasticQuote: 'Unique IDs for your unique problems',
        path: '/uuid-generator',
        icon: 'Hash',
        gradient: 'linear-gradient(135deg, #6366f1, #8b5cf6)',
        category: ToolCategory.DEVELOPER,
        features: ['Multiple UUID versions', 'Bulk generation', 'UUID validation', 'Different output formats'],
        keywords: ['uuid', 'guid', 'generate', 'validate', 'unique', 'identifier'],
        shortcuts: ['uuid', 'guid', 'id'],
        isPremium: false,
        estimatedTimeSaved: 3,
        isNew: true
      },
      {
        id: 'jwt-decoder',
        name: 'JWT Decoder',
        description: 'Decode and analyze JSON Web Tokens with detailed inspection',
        sarcasticQuote: 'JWT structure explanation included',
        path: '/jwt-decoder',
        icon: 'Shield',
        gradient: 'linear-gradient(135deg, #f97316, #ef4444)',
        category: ToolCategory.DEVELOPER,
        features: ['JWT parsing', 'Header/payload display', 'Token validation', 'Security information'],
        keywords: ['jwt', 'json', 'web', 'token', 'decode', 'auth', 'security'],
        shortcuts: ['jwt', 'token', 'auth'],
        isPremium: false,
        estimatedTimeSaved: 5,
        isNew: true
      },
